        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2 text-capitalize">Zarqa E-Mall</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{str_contains(Request::url(), '/stores') ? 'active' : ''}}">
              <a href="stores" class="menu-link">
                ...
                <div data-i18n="Analytics">Stores</div>
              </a>
            </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="https://img.myloview.com/posters/unknown-male-avatar-profile-image-businessman-vector-700-199769934.jpg" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
