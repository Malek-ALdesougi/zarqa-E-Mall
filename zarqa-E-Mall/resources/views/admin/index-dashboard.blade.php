      ...
      <div class="col-lg-3 col-md-12 col-6 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="card-title mb-2">548</h3>
            {{-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +72.80%</small> --}}
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-12 col-6 mb-4">
        <div class="card">
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
              <div class="avatar flex-shrink-0">
                <i style="scale:2;" class='bx bxs-shopping-bag-alt success chart rounded text-danger'></i>
            ...
            <h3 class="card-title mb-2">22,540</h3>
            {{-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +72.80%</small> --}}
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-12 col-6 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="card-title mb-2">348</h3>
            {{-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +72.80%</small> --}}
          </div>
        </div>
      </div>
