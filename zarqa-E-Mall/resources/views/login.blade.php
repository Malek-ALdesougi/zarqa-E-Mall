...
@section('content')
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form>
                                        ...
                                        <h5 class="fw-normal mb-3 pb-3 my-font right" style="letter-spacing: 1px;">تسجيل
                                            الدخول إلى حسابك</h5>
    ...
    <div style="background-color:#223b4b;">
        ...
        <div id="register" style="border-radius:20px;"
            class="container w-75 d-flex justify-content-center bg-light col-md-10">
